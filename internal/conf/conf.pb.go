...
type Fix struct {
	...
	TargetCompId  string                 `protobuf:"bytes,2,opt,name=target_comp_id,json=targetCompId,proto3" json:"target_comp_id,omitempty"`
	ApiKey        string                 `protobuf:"bytes,3,opt,name=api_key,json=apiKey,proto3" json:"api_key,omitempty"`
	ApiSecret     string                 `protobuf:"bytes,4,opt,name=api_secret,json=apiSecret,proto3" json:"api_secret,omitempty"`
	ApiPassphrase string                 `protobuf:"bytes,5,opt,name=api_passphrase,json=apiPassphrase,proto3" json:"api_passphrase,omitempty"`
	PortfolioId   string                 `protobuf:"bytes,6,opt,name=portfolio_id,json=portfolioId,proto3" json:"portfolio_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Fix) GetAccountId() string {
	if x != nil {
		return x.AccountId
	}
	return ""
...
func (x *Fix) GetTargetCompId() string {
	if x != nil {
...
func (x *Fix) GetApiSecret() string {
	if x != nil {
		return x.ApiSecret
	}
	return ""
...
func (x *Fix) GetApiPassphrase() string {
	if x != nil {
...
func (x *Fix) GetPortfolioId() string {
	if x != nil {
...
type Data struct {
	...
	Coinbase      *Data_Coinbase         `protobuf:"bytes,3,opt,name=coinbase,proto3" json:"coinbase,omitempty"`
	Fix           *Fix                   `protobuf:"bytes,4,opt,name=fix,proto3" json:"fix,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Data) GetCoinbase() *Data_Coinbase {
	if x != nil {
		return x.Coinbase
	}
	return nil
...
func (x *Data_Coinbase) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Coinbase) ProtoMessage() {}

func (x *Data_Coinbase) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Coinbase.ProtoReflect.Descriptor instead.
func (*Data_Coinbase) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3, 2}
}

func (x *Data_Coinbase) GetApiKey() string {
	if x != nil {
		return x.ApiKey
	}
	return ""
...
func (x *Data_Coinbase) GetApiSecret() string {
	if x != nil {
		return x.ApiSecret
	}
	return ""
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xcc\x01\n" +
	"\x03Fix\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\tR\taccountId\x12$\n" +
	"\x0etarget_comp_id\x18\x02 \x01(\tR\ftargetCompId\x12\x17\n" +
	"\aapi_key\x18\x03 \x01(\tR\x06apiKey\x12\x1d\n" +
	"\n" +
	"api_secret\x18\x04 \x01(\tR\tapiSecret\x12%\n" +
	"\x0eapi_passphrase\x18\x05 \x01(\tR\rapiPassphrase\x12!\n" +
	"\fportfolio_id\x18\x06 \x01(\tR\vportfolioId\"\xfb\x03\n" +
	"\x04Data\x125\n" +
	"\bdatabase\x18\x01 \x01(\v2\x19.kratos.api.Data.DatabaseR\bdatabase\x12,\n" +
	"\x05redis\x18\x02 \x01(\v2\x16.kratos.api.Data.RedisR\x05redis\x125\n" +
	"\bcoinbase\x18\x03 \x01(\v2\x19.kratos.api.Data.CoinbaseR\bcoinbase\x12!\n" +
	"\x03fix\x18\x04 \x01(\v2\x0f.kratos.api.FixR\x03fix\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\x1aB\n" +
	"\bCoinbase\x12\x17\n" +
	"\aapi_key\x18\x01 \x01(\tR\x06apiKey\x12\x1d\n" +
	"\n" +
	"api_secret\x18\x02 \x01(\tR\tapiSecretB%Z#limit-order-book/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Data_Coinbase)(nil),       // 8: kratos.api.Data.Coinbase
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 6: kratos.api.Data.coinbase:type_name -> kratos.api.Data.Coinbase
	2,  // 7: kratos.api.Data.fix:type_name -> kratos.api.Fix
